...
class CalificacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calificacion" do
    assert_difference('Calificacion.count') do
      post calificacions_url, params: { calificacion: { nombre: @calificacion.nombre, tipo_trabajadors_id: @calificacion.tipo_trabajadors_id, trabajadors_id: @calificacion.trabajadors_id } }
    end
  ...
  test "should update calificacion" do
    patch calificacion_url(@calificacion), params: { calificacion: { nombre: @calificacion.nombre, tipo_trabajadors_id: @calificacion.tipo_trabajadors_id, trabajadors_id: @calificacion.trabajadors_id } }
