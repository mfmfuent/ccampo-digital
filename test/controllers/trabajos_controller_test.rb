...
class TrabajosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabajo" do
    assert_difference('Trabajo.count') do
      post trabajos_url, params: { trabajo: { actividads_id: @trabajo.actividads_id, descripcion: @trabajo.descripcion, nombre: @trabajo.nombre } }
    end
  ...
  test "should update trabajo" do
    patch trabajo_url(@trabajo), params: { trabajo: { actividads_id: @trabajo.actividads_id, descripcion: @trabajo.descripcion, nombre: @trabajo.nombre } }
